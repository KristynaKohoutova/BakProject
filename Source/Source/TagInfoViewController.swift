...
class TagInfoViewController: UITableViewController{
    ...
    func addToList(){
        let tag_epc = tag.epc
        myDB_Manager.insert(epc: tag_epc)
    }
    ...
    @IBOutlet weak var btnAddPressed: UIButton!
    
    @IBAction func addToList(_ sender: UIButton) {
        btnAddPressed.setTitle("Tag added!", for: .normal)
        btnAddPressed.setTitleColor(.white, for: .normal)
        addToList()
    }
