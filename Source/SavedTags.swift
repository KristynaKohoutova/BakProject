...
class SavedTags: UIViewController, UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        //let searchForTag = SearchForTagViewController()
        //searchForTag.tagEpc = resultValues[indexPath.row]
        //self.navigationController?.pushViewController(searchForTag, animated: true)
